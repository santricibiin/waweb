    ...
    <ToastProvider>
      <div className="grid gap-8 md:grid-cols-[220px_1fr]">
        <aside className="space-y-1">
          ...
          <NavLink href="/dashboard/logs" icon="logs">Log OTP</NavLink>
...
function NavLink({
  ...
  href: string;
  icon: "home" | "wa" | "key" | "book" | "play" | "chat" | "logs";
  children: React.ReactNode;
}) {
  const icons: Record<string, JSX.Element> = {
    ...
    logs: <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm-2 16H8v-2h4v2zm4-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z" />,
